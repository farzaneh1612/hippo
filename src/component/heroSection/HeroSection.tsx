  ...
  return (
    <section style={{height:height}} className="hero">
      <div className="hero-content">
        ...
        <p  className="hero-paragraph">HPO is the utility token of Hippo Wallet, designed for security, passive income,<br />
            and financial liberty. Buy and stake HPO to grow your wealth while exploring <br />
